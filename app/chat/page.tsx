...
<body>
  ...
  const handleSend = async (e: React.FormEvent) => {
    ...
    if (currentChat?.type === 'bot' || !currentChat) {
      ...
      // Generate response
      const fullResponse = generateResponse(userInput)
        ...
        {showChatList && !currentChatId ? (
          ...
          {isLoading && !streamingContent && (
            ...
            <div className="flex gap-2">
              ...
              <label
                htmlFor="file-upload"
                className="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-3 rounded-lg transition duration-200 cursor-pointer flex items-center justify-center"
                title="Upload file"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
